...
class Settings_Fields_Media {
	...
	public function settings() {
		...
		add_settings_field( 'misp_hard_crop_medium', __( 'Medium crop', MISP_DOMAIN ), [ $this, 'medium_crop' ], 'media', 'default', [ __( 'Crop Medium size to exact dimensions', MISP_DOMAIN ) ] );

		add_settings_field( 'misp_hard_crop_large', __( 'Large crop', MISP_DOMAIN ), [ $this, 'large_crop' ], 'media', 'default', [ __( 'Crop Large size to exact dimensions', MISP_DOMAIN ) ] );

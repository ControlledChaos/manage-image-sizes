...
function misp_options_init(){
	...
	register_setting( 'misp_options'
		, misp_get_option_name()   // Settings are per user
		, 'misp_options_validate' );

	add_settings_section( 'misp_main'
	...
	add_settings_field( 'misp_imgedit_max_size'
		, __('Crop Picture Size', MISP_DOMAIN)
		, 'misp_imgedit_size_display'
		, 'misp'
		, 'misp_main' );

	add_settings_field( 'misp_reset'
	...
	if ( current_user_can( 'manage_options' ) ){
		register_setting( 'misp_options'
			, 'misp-site-options'     // Settings are site-wide
			, 'misp_site_options_validate' );
		add_settings_section( 'misp_site'
			, __('Site Options', MISP_DOMAIN)
			, 'misp_site_options_html'
			, 'misp' );
		add_settings_field( 'misp_sizes'
			, __('Thumbnails', MISP_DOMAIN)
			, 'misp_sizes_display'
			, 'misp'
			, 'misp_site' );
		add_settings_field( 'misp_jpeg_compression'
			, __('JPEG Compression', MISP_DOMAIN)
			, 'misp_jpeg_compression_display'
			, 'misp'
			, 'misp_site' );
		add_settings_field( 'misp_cache_buster'
...
function misp_options_page(){
	/*<code><pre><?php print_r( misp_get_options() ); ?></pre></code>*/
?>

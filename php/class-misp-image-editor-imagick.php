...
class MISP_Image_Editor_Imagick extends WP_Image_Editor_Imagick {
	...
	public function crop( $src_x, $src_y, $src_w, $src_h, $dst_w = null, $dst_h = null, $src_abs = false ) {
		if ( misp_is_crop_border_enabled( $src_w, $src_h, $dst_w, $dst_h ) ){
			...
			if ( misp_is_crop_border_opaque() ) {
				$color = new ImagickPixel( $_GET['misp-fit-crop-color'] );
			}

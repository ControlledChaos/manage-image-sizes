...
* check that option `misp_jpeg_compression` exists before trying to access it
...
* Added new custom `misp-edit` capability.
...
* Thumbnails are appended with "-misp" to differentiate images created with this plugin
